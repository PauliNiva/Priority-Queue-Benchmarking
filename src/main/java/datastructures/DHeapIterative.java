 ...
 */
public class DHeapIterative implements Heap {
     ...
     */
    public DHeapIterative(int arraySize, int numberOfChildren) {
        capacity = arraySize;
    ...
    /**
     * Method that moves the node up in the tree until the heap
    ...
    /**
     * Auxiliary method that swaps the two nodes places.
     * @param i parents index.
     * @param j children index.
     */
