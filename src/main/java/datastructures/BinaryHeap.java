...
public class BinaryHeap {
     ...
     * @param i index of the value whose left child is being get.
     ...
     * @param i index of the value whose right child is being get.
     ...
     * @param i index of the value whose getParent is being get.
