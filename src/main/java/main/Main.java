...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        delete.deleteBenchmark(30000);
        delete.deleteBenchmark(50000);
        delete.deleteBenchmark(100000);
        delete.deleteBenchmark(1000000);
        arraySorting.arraySortingBenchmark(100);
        arraySorting.arraySortingBenchmark(1000);
        arraySorting.arraySortingBenchmark(10000);
        arraySorting.arraySortingBenchmark(30000);
        arraySorting.arraySortingBenchmark(50000);
